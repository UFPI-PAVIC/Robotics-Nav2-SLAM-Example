...
#ifndef CUSTOM_INTERFACES__MSG__DETAIL__IOTDEVICEREQUEST__STRUCT_H_
#define CUSTOM_INTERFACES__MSG__DETAIL__IOTDEVICEREQUEST__STRUCT_H_
...
#endif  // CUSTOM_INTERFACES__MSG__DETAIL__IOTDEVICEREQUEST__STRUCT_H_
